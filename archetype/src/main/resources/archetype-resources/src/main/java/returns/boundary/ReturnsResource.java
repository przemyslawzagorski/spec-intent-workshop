...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.returns.boundary;
...
import ${package}.returns.control.EligibilityCheck;
import ${package}.returns.control.Orders;
import ${package}.returns.control.Returns;
import ${package}.returns.entity.Problem;
import ${package}.returns.entity.ReturnRequest;

/**
 * Granica komponentu zwrotow - jedyne miejsce, ktore wie o HTTP.
 *
 * <p>Kontrakt tego zasobu opisuje docs/contract/openapi.yaml - co przyjmujemy
 * i co zwracamy. To, PRZY JAKICH WARTOSCIACH zapadaja decyzje, opisuje
 * return-policy.yaml. Zmiana progu biznesowego nie dotyka tego pliku.
 */
@Path("returns")
@ApplicationScoped
